...
grid_plot <- ggarrange(plot_230,plot_260,plot_280,plot_650,plot_980,plot_230_280, ncol=2,nrow=3,
...
plot_25_5 <- ggplot(turb_25_980, aes(x=1/Dilution, y=OD, group=Sample, color=Sample)) + 
...
plot_35_5 <- ggplot(turb_35_980, aes(x=1/Dilution, y=OD, group=Sample, color=Sample)) + 
  geom_line(size = 0.8, alpha=0.5) + geom_point(size=1.5) + ylab("OD at 980nm") +
  xlab("Concentration (1/Dilution)")
plot_35_5
...
plot_45_5 <- ggplot(turb_45_980, aes(x=1/Dilution, y=OD, group=Sample, color=Sample)) + 
  geom_line(size = 0.8, alpha=0.5) + geom_point(size=1.5) + ylab("OD at 980nm") +
  xlab("Concentration (1/Dilution)")
plot_45_5
...
plot_55_5 <- ggplot(turb_55_980, aes(x=1/Dilution, y=OD, group=Sample, color=Sample)) + 
  geom_line(size = 0.8, alpha=0.5) + geom_point(size=1.5) + ylab("OD at 980nm") +
  xlab("Concentration (1/Dilution)")
plot_55_5
...
plot_65_5 <- ggplot(turb_65_980, aes(x=1/Dilution, y=OD, group=Sample, color=Sample)) + 
  geom_line(size = 0.8, alpha=0.5) + geom_point(size=1.5) + ylab("OD at 980nm") +
  xlab("Concentration (1/Dilution)")
plot_65_5
